...
// Para la ruta de la base de datos, usamos el ID del proyecto que ya tenemos
        ...
        <div className="bg-gray-100 min-h-screen font-sans">
            ...
            <main className="max-w-4xl mx-auto">
             ...
             <footer className="text-center py-4 text-xs text-gray-400">
                App de Finanzas Personales. ID de sesión: <span className="font-mono">{userId || "N/A"}</span>
            </footer>
        </div>
    );
}
